        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    ADD Product page<a href="/showProduct" type="button" class="btn btn-primary col-3 ml-2">Show Product</a>
                </div>
                <!-- /.card-header -->
                
                <form class="my-5" method="POST" action="/addProduct_insert" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3 text-center">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="name" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('title') }}" required autocomplete="name" autofocus>
                        ...
                        <div class="row mb-3 text-center">
                            ...
                            <div class="col-md-6">
                                <input id="description" type="text" class="form-control @error('price') is-invalid @enderror" name="description" value="{{ old('description') }}" required autocomplete="description" autofocus>
                        ...
                        <div class="row mb-3 text-center">
                            ...
                            <div class="col-md-6">
                                <input id="manufactured_date" type="date" class="form-control @error('manufactured_date') is-invalid @enderror" name="manufactured_date" value="{{ old('manufactured_date') }}" required autocomplete="manufactured_date" autofocus>
                        ...
                        <div class="row mb-3 text-center">
                            ...
                            <div class="col-md-6">
                                <input id="expiry_date" type="date" class="form-control @error('expiry_date') is-invalid @enderror" name="expiry_date" value="{{ old('expiry_date') }}" required autocomplete="expiry_date" autofocus>
