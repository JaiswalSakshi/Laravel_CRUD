        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    EDIT User page<a href="/showGuestProfile" type="button" class="btn btn-primary col-3 ml-2">Show Profile</a>
                </div>
                <!-- /.card-header -->
                
                <form class="my-5" method="POST" action="/updateUserProfile" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3 text-center">
                            ...
                            <input class="form-check-input" type="radio" name="gender" id="male" value="{{ $data->gender }}" required>
                            <label class="form-check-label" for="male">
                                Male
                            </label>
                            </div>
                            <div class="form-check">
                            <input class="form-check-input" type="radio" name="gender" id="female" value="{{ $data->gender }}" required checked>
